...
def gnss_ins_sim_publisher():
    ...
    # parse params:
    motion_def_name = rospy.get_param('gnss_ins_sim_publisher_node/motion_file')
    sample_freq_imu = rospy.get_param('gnss_ins_sim_publisher_node/sample_frequency/imu')
    sample_freq_gps = rospy.get_param('gnss_ins_sim_publisher_node/sample_frequency/gps')
    topic_name_imu  = rospy.get_param('gnss_ins_sim_publisher_node/topic_name')

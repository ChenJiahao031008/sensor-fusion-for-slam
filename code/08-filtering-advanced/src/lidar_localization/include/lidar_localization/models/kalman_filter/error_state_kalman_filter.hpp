...
private:
  ...
  // --------------------ADD:运动约束模型-------------------- //
  static constexpr int kDimMeasurementPoseWithMC{8};
  static constexpr int kDimMeasurementPoseWithMCNoise{8};

  using MatrixGPoseWithMC = Eigen::Matrix<double, kDimMeasurementPoseWithMC, kDimState>;
  using MatrixCPoseWithMC = Eigen::Matrix<double, kDimMeasurementPoseWithMC, kDimMeasurementPoseWithMCNoise>;
  using MatrixRPoseWithMC = Eigen::Matrix<double, kDimMeasurementPoseWithMCNoise, kDimMeasurementPoseWithMCNoise>;

  using VectorYPoseWithMC = Eigen::Matrix<double, kDimMeasurementPoseWithMC, 1>;
  using MatrixKPoseWithMC = Eigen::Matrix<double, kDimState, kDimMeasurementPoseWithMC>;
  using MatrixQPoseWithMC = Eigen::Matrix<double, kDimState * kDimMeasurementPoseWithMC, kDimState>;

  MatrixGPoseWithMC GPoseWithMC_ = MatrixGPoseWithMC::Zero();
  MatrixCPoseWithMC CPoseWithMC_ = MatrixCPoseWithMC::Zero();
  MatrixRPoseWithMC RPoseWithMC_ = MatrixRPoseWithMC::Zero();
  MatrixQPoseWithMC QPoseWithMC_ = MatrixQPoseWithMC::Zero();

  VectorYPoseWithMC YPoseWithMC_ = VectorYPoseWithMC::Zero();
  // -------------------------------------------------------- //
  ...
  void CorrectErrorEstimationPoseWithMC(
    const Eigen::Matrix4d &T_nb, const Eigen::Vector3d &v_b, const Eigen::Vector3d &w_b,
    Eigen::VectorXd &Y, Eigen::MatrixXd &G, Eigen::MatrixXd &K);
